...
export function createComputerTools(
  ...
  const tools: RuntimeTool<unknown>[] = [
    ...
    },
    {
      ...
      // A verified 12000-character window can expand sixfold in JSON escaping.
      // Keep serialization from corrupting a window already bounded by the reader.
      maxResultCharacters: CONTENT_REFERENCE_WINDOW_CHARACTERS * 6 + 32_000,
      description: [
    ...
    },
    {
      ...
      description: [
        ...
        "Profiles cover generic_file, html, html_ppt, word (.doc and .docx), docx (Word-family alias), xlsx, pptx, pdf, markdown, image, and json.",
    ...
    },
    {
      ...
      description: [
        ...
        "Do not use a structured data artifact such as .json, .csv, .tsv, .xlsx, .doc, .docx, .pptx, or .pdf as a Python, Node, shell, or other interpreter entry point.",
