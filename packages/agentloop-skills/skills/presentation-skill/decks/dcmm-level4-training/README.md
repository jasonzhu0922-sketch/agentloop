...
This workspace is the saved authoring source for the `dcmm-4` deck.
...
```bash
python3 ../../scripts/init_deck_workspace.py --workspace . --title "DCMM 4级（量化管理级）培训课件" --style-preset <preset> --user-prompt "Original user request"
```
