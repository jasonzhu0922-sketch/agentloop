...
{{
  ...
  "slide_quality_contract": {{
    ...
    "qa_gates": {{
      "fail_on": ["planning_errors", "overflow", "overlap", "placeholder_text", "visual_review_blockers"],
      "record_warnings": ["planning_warnings", "whitespace_warnings", "design_readability_warnings"],
      "strict_warning_gates": "only when the user, current Plan evidence contract, or delivery rubric explicitly requires warning-free QA evidence",
      "required_commands": [
  ...
  "qa_contract": {{
    ...
    "fail_on": ["planning errors", "overflow", "overlap", "undersized text", "visual review blockers"],
    "record_warnings": ["awkward whitespace", "planning warnings", "design readability warnings"],
