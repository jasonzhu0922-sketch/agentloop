...
```bash
python3 ../../scripts/build_workspace.py --workspace . --scaffold-data-artifacts --auto-bind-artifacts --qa --overwrite
```

Run strict final polish when warning-free QA evidence is explicitly required:
...
7. Run `python3 ../../scripts/build_workspace.py --workspace . --scaffold-data-artifacts --auto-bind-artifacts --qa --overwrite`
...
12. Before final delivery, run `python3 ../../scripts/build_workspace.py --workspace . --qa --overwrite`; add strict warning gates only when warning-free QA evidence is explicitly required.
