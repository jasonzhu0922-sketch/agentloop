...
PROFILE_CONTRACTS: dict[str, dict[str, Any]] = {
    "quality-first": {
        ...
        "workflow": [
            ...
            "run source readiness and artifact acceptance",
    ...
    "balanced": {
        ...
        "workflow": [
            ...
            "build the artifact and run acceptance checks",
    ...
    *,
    ...
    brief = {
        ...
        "completion_rubric": [
            ...
            "Artifact acceptance passes; strict QA gates are required only when requested or declared by the delivery rubric.",
